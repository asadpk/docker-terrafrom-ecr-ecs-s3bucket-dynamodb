...
# Hands-on Project: Implementation - Part 2
...
- **ECS | Cluster | Create Cluster**
    ...
    - **Infrastructure: `Amazon EC2 instances`**
        - ***Create***
     # Hands-on Project: Implementation - Part 3
...
- Or, once you are in a "Task Definition", click on "Deploy" | "Create service"
    ...
    ![image.png](attachment:248c1c61-c4da-470a-8e43-5835a46eb8c3:image.png)
...
- **Load Balancing**
    ...
    - **Load balancer name: `humangov-lb`**
        ...
        ![image.png](attachment:2958bfe3-74c6-4085-8c46-6a6230a821cf:image.png)
...
[Driving License - Sample.pdf](attachment:dfa69d32-c4b7-4b01-9869-9523698a6586:Driving_License_-_Sample.pdf)

## Step 05 - Collecting the Evidence

- **Evidence 1:** **Screen showing the ECS service running.**
    
    ![image.png](attachment:a1e5daef-0096-40fd-9e07-8f55740bedf7:image.png)
    

- **Evidence 2:** **Screen showing the exclusion of the ECS Fargate Cluster (No clusters).**
    
    ![image.png](attachment:7fd9d41e-9037-4aa9-b7fa-0afe25f81d4d:image.png)
